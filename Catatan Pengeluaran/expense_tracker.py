...
class ExpenseTracker:
    ...
    def setup_gui(self):
        ...
        tk.Button(form_frame, text="Delete Selected Expense", command=self.delete_expense).grid(row=5, column=0, columnspan=2, pady=5)
    ...
    def add_expense(self):
        try:
            ...
            try:
                ...
                raise ValueError("Harap isi Tahun-Bulan-Tanggal dengan benar")

            description = self.description_entry.get()
            if not description:
                raise ValueError("Harap isi data dengan lengkap!")
            
            amount_str = self.amount_entry.get()
            try:
                amount = float(amount_str)
            except ValueError:
                raise ValueError("Isi bagian 'Amount' dengan angka")
    ...
    def delete_expense(self):
        ...
        if selected_item:
            ...
            messagebox.showwarning("Selection Error", "Harap pilih data yang ingin dihapus!")
